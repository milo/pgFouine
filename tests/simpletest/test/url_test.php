<?php
    // $Id: url_test.php,v 1.1 2005/11/09 23:41:18 gsmet Exp $
    ...
    class TestOfUrl extends UnitTestCase {
        ...
        function testBlitz() {
            ...
            $this->assertUrl(
                    ...
                    [false, "username", "password", "somewhere.com", 243, "/", "com", "?1,2", false],
                    [],
                    [1, 2]);
            $this->assertUrl(
            ...
            $this->assertUrl(
                    ...
                    [false, false, false, false, false, "/this/that/here.php", false, "?a=1&b=2?3,4", false],
                    ["a" => "1", "b" => "2"],
                    [3, 4]);
            $this->assertUrl(
